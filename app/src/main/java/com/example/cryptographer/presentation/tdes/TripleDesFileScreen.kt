...
import com.example.cryptographer.presentation.tdes.components.TripleDesFileDecryptionSection
import com.example.cryptographer.presentation.tdes.components.TripleDesFileEncryptionSection
import com.example.cryptographer.presentation.tdes.components.TripleDesFileInfoCard
import com.example.cryptographer.presentation.tdes.components.TripleDesFileScreenTitle
import com.example.cryptographer.presentation.tdes.components.TripleDesKeySelectionSection

/**
 * Screen for Triple DES file encryption and decryption.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TripleDesFileScreen(viewModel: TripleDesFileViewModel) {
    ...
    Column(
        ...
        TripleDesFileDecryptionSection(
            uiState = uiState,
