...
import com.example.cryptographer.presentation.aes.AesFileUiState
import kotlinx.coroutines.launch

@Composable
fun AesFileDecryptionSection(
    uiState: AesFileUiState,
...
@Composable
private fun AesFileDecryptionFields(
    uiState: AesFileUiState,
    onInputChange: (String) -> Unit,
    onOutputChange: (String) -> Unit,
    onPickInput: () -> Unit,
...
@Composable
private fun AesFileDecryptionResults(uiState: AesFileUiState, clipboard: Clipboard) {
...
@Composable
private fun AesFileDecryptButton(isLoading: Boolean, enabled: Boolean, onClick: () -> Unit) {
    Button(
        onClick = onClick,
        modifier = Modifier
            .fillMaxWidth()
