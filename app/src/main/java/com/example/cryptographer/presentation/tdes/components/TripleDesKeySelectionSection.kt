...
import com.example.cryptographer.presentation.key.components.getAlgorithmDisplayName

private const val KEY_ID_PREVIEW_LENGTH = 8

@Composable
fun TripleDesKeySelectionSection(
...
@Composable
private fun TripleDesKeySelectionItem(keyItem: KeyView, isSelected: Boolean, onSelected: () -> Unit) {
    Row(
        ...
        Column(modifier = Modifier.padding(start = 8.dp)) {
            Text(
                text = getAlgorithmDisplayName(keyItem.algorithm),
