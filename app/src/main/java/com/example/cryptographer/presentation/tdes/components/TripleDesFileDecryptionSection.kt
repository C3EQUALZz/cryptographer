...
@Composable
fun TripleDesFileDecryptionSection(
    ...
    Card(
        ...
        Column(
            ...
            TripleDesFileDecryptionResults(
                uiState = uiState,
                clipboard = clipboard,
            )
        }
...
@Composable
private fun TripleDesFileDecryptionFields(
    uiState: TripleDesFileUiState,
    onInputChange: (String) -> Unit,
    onOutputChange: (String) -> Unit,
    onPickInput: () -> Unit,
...
@Composable
private fun TripleDesFileDecryptionResults(uiState: TripleDesFileUiState, clipboard: Clipboard) {
...
@Composable
private fun TripleDesFileDecryptButton(isLoading: Boolean, enabled: Boolean, onClick: () -> Unit) {
    Button(
        onClick = onClick,
        modifier = Modifier
            .fillMaxWidth()
