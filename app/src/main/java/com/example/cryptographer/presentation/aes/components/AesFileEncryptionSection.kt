...
@Composable
private fun AesFileEncryptionFields(
    uiState: AesFileUiState,
    onInputChange: (String) -> Unit,
    onOutputChange: (String) -> Unit,
    onPickInput: () -> Unit,
...
@Composable
private fun AesFileEncryptionResults(uiState: AesFileUiState, clipboard: Clipboard) {
...
@Composable
private fun AesFileEncryptButton(isLoading: Boolean, enabled: Boolean, onClick: () -> Unit) {
    Button(
        onClick = onClick,
        modifier = Modifier
            .fillMaxWidth()
