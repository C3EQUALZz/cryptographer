...
@Composable
fun KeySelectionSection(availableKeys: List<KeyView>, selectedKeyId: String?, onKeySelected: (String) -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .border(
...
@Composable
private fun KeySelectionItem(keyItem: KeyView, isSelected: Boolean, onSelected: () -> Unit) {
    Row(
