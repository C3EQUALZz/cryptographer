...
@Composable
fun TripleDesDecryptionSection(
...
@Composable
private fun TripleDesDecryptionButton(isLoading: Boolean, enabled: Boolean, onClick: () -> Unit) {
    Button(
        onClick = onClick,
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
private fun TripleDesDecryptedResultCard(decryptedText: String, clipboard: Clipboard) {
