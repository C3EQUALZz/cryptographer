...
/**
 * Value Object for AES S-box.
 *
 * Encapsulates the AES substitution box (S-box) used in SubBytes transformation.
 *
 * S-box provides non-linear byte substitution, which is crucial for AES security.
 * Currently, only encryption is implemented (AES-GCM uses CTR mode, which only requires encryptBlock).
 *
...
object AesSBox : BaseValueObject() {
    ...
    /**
     * Gets S-box value for a given byte.
     *
